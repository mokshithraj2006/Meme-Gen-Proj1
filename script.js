...
data = {memes,jokes,quotes,riddles};
...
function showmeme(){
    ...
    const is_img = document.querySelector('img');
    clearall();
...
function showjokes(){
    ...
    clearall();
    content.innerHTML = "<p> Your Joke</p>";
...
function showquote(){
    ...
    clearall();
    content.innerHTML = "<p> Your quote</p>";
...
function showriddle(){
    ...
    contenta.setAttribute('id','riddle-answer');
    contenta.hidden = true;

    question = riddle.question;
    answer = riddle.answer;

    contentq.innerHTML = question;
    contenta.innerHTML = answer;

    clearall();
    container.innerHTML = "<p> Your question</p>";
    container.appendChild(contentq);
...
function reveal(){
    ...
    ansElem = document.querySelector('#riddle-answer');
    if(ansElem.hidden==true){
        ansElem.hidden=false;
    }else{
        window.alert("Answer Aldready there Dumbo");
    }
}
function clearall(){
    ...
    const riddlwcontainer = document.querySelector(".riddle-content");
    memecontainer.innerHTML ="";
    jokecontainer.innerHTML ="";
    quotecontainer.innerHTML="";
    riddlwcontainer.innerHTML="";
}
